...
torch.save(sharp_list, './result/Final_checkpoints/deep_tanh_sharpness_lock_2_conv'+str(activation))
torch.save(x_1, './result/Final_checkpoints/deep_tanh_x1_conv'+str(activation))
torch.save(x_2, './result/Final_checkpoints/deep_tanh_x2_conv'+str(activation))
torch.save(sharp_bad_list, './result/Final_checkpoints/deep_tanh_sharpness_bad_conv'+str(activation))
torch.save(A_part_sharp_list, './result/Final_checkpoints/deep_tanh_A_sharpness_conv'+str(activation))
torch.save(loss_list, './result/Final_checkpoints/deep_tanh_loss_conv'+str(activation))
torch.save(R_list, './result/Final_checkpoints/deep_tanh_R_conv'+str(activation))
...
torch.save(norm2_list, './result/Final_checkpoints/deep_tanh_norm2_list_conv'+str(activation))
torch.save(norm2_bad_list, './result/Final_checkpoints/deep_tanh_norm2_bad_list_conv'+str(activation))
#
#
#
#
